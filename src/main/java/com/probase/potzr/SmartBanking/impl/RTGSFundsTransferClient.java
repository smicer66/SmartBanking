...
public class RTGSFundsTransferClient implements IFundsTransferClient {
    ...
    public FundsTransferResponse doFundsTransfer(Client client, Collection<ClientSetting> clientSettings,
        ...
        transaction.setTransactionAmount(fundsTransferRequest.getTransferAmount());
        ...
        try {
            ...
            if (response.getBody() != null) {
                ...
                fundsTransferResponse.setTransactionId(transaction.getTransactionId());
            ...
            throw new ApplicationException("Failed to send funds", e);
        }
        return null;
    }
}
